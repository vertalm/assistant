module CommandHandlers
  ...
  def self.handle_start_command(state, bot, message)
    ...
    if assistants.count > 0
      ...
      if ENV['ADMINISTRATOR_USERNAME'] == 'https://t.me/vertalm'
      ...
      elsif ENV['ADMINISTRATOR_USERNAME'] == 'https://t.me/vaskatabaska'
        ...
        if ENV['ADMINISTRATOR_USERNAME'] == 'https://t.me/vertalm' ||  ENV['ADMINISTRATOR_USERNAME'] == 'https://t.me/vaskatabaska'
          assistants = user.open_ai_assistants
